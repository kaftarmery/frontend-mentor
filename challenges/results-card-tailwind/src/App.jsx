  ...
  return (
    <>
      <main className="font-Hanken flex flex-col min-h-screen items-center justify-center">
        <div className="flex w-[590px] h-[430px] rounded-3xl bg-white">
          <aside className="flex flex-col px-12 bg-gradient-to-t from-slate-blue-dark to-slate-blue-light rounded-3xl justify-center items-center gap-8">
            ...
            <div className="gap-2 w-40 h-40 bg-gradient-to-b from-violet to-slate-blue-very-light p-4 text-white rounded-full flex-col flex justify-center items-center text-center">
              ...
              <span className="text-lavender text-xs opacity-50">of 100</span>{" "}
            </div>
            <div className="text-white font-medium text-3xl">Great</div>
            <div className=" opacity-80 text-lavender font-medium text-center text-sm">
          ...
          <div className="py-8 px-8 flex flex-col justify-center items-left gap-7">
            ...
            <ul className="flex-col flex gap-4">
              <li className="rounded-md py-3 px-3 flex bg-red-light justify-between">
                ...
                <p className="text-red-default">Reaction</p>
                <p>
              ...
              <li className="rounded-md py-3 px-3 flex justify-between bg-orange-light">
                ...
                <p className="text-orange-default ">Memory</p>
                <p>
              ...
              <li className="rounded-md py-3 px-3 justify-between flex bg-green-light ">
                ...
                <p className="text-green-default justify-between">Verbal</p>
                <p>
            ...
            <button className="bg-gray-dark-gray text-pale-blue px-5 py-3 text-center w-[230px] rounded-3xl">
              Continue
            </button>
          </div>
        </div>
